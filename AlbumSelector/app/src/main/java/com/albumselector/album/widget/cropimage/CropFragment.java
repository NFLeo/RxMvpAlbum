...
import com.albumselector.album.utils.FileUtils;
import com.albumselector.album.widget.cropimage.crop.CropView;
...
import static com.albumselector.album.utils.CommonUtils.checkNotNull;
...
public class CropFragment extends Fragment {
    ...
    public void onAttach(Activity activity) {
        ...
        if (activity instanceof CropImageListener) {
            mListener = (CropImageListener) activity;
        } else {
