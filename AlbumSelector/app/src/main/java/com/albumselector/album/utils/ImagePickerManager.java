...
public class ImagePickerManager
{
     ...
     */
    public ImagePickerManager(Context context, File imageDir) {
        mContext = context;
        mImageDir = imageDir;
        if (!mImageDir.exists()) {
            mImageDir.mkdirs();
    ...
    public Intent getCropPictureIntent(Context context, String imagePath) throws IOException {
        Intent intent = null;

        if (context != null && imagePath != null && !"".equals(imagePath)) {
